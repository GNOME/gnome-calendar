...
#define _GCAL_TEST_SERVER_CALENDAR_BEGIN "BEGIN:VCALENDAR"
#define _GCAL_TEST_SERVER_CALENDAR_END "END:VCALENDAR"

#define GCAL_TEST_SERVER_EMPTY_CRLF_CALENDAR \
  _GCAL_TEST_SERVER_CALENDAR_BEGIN "\r\n" _GCAL_TEST_SERVER_CALENDAR_END

#define GCAL_TEST_SERVER_EMPTY_LF_CALENDAR \
  _GCAL_TEST_SERVER_CALENDAR_BEGIN "\n" _GCAL_TEST_SERVER_CALENDAR_END
