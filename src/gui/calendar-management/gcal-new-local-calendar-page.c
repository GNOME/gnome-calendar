...
static void          cancel_validation_discover                               (GcalNewLocalCalendarPage *self);
...
static void
toggle_url_entry_pulsing (GcalNewLocalCalendarPage *self,
                          gboolean             pulsing)
{
...
static void
update_url_entry_state (GcalNewLocalCalendarPage *self,
                        EntryState           state,
...
static void
discover_sources (GcalNewLocalCalendarPage *self)
{
...
{
  GcalNewLocalCalendarPage *self = data;
                       ...
                       gpointer      user_data)
{
  ...
  self = GCAL_NEW_LOCAL_CALENDAR_PAGE (user_data);
...
static void
cancel_validation_discover (GcalNewLocalCalendarPage *self)
{
...
gcal_new_calendar_page_finalize (GObject *object)
{
  ...
  G_OBJECT_CLASS (gcal_new_local_calendar_page_parent_class)->finalize (object);
}
...
gcal_new_local_calendar_page_class_init (GcalNewLocalCalendarPageClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, GcalNewLocalCalendarPage, calendar_address_entry);
  gtk_widget_class_bind_template_child (widget_class, GcalNewLocalCalendarPage, credentials_dialog);
  gtk_widget_class_bind_template_child (widget_class, GcalNewLocalCalendarPage, credentials_password_entry);
  gtk_widget_class_bind_template_child (widget_class, GcalNewLocalCalendarPage, credentials_user_entry);
  ...
  gtk_widget_class_bind_template_child (widget_class, GcalNewLocalCalendarPage, web_sources_listbox);
  gtk_widget_class_bind_template_child (widget_class, GcalNewLocalCalendarPage, web_sources_revealer);
