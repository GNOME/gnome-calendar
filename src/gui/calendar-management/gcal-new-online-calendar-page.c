/* gcal-new-online-calendar-page.c
 *
...
#define G_LOG_DOMAIN "GcalNewOnlineCalendarPage"
...
struct _GcalNewOnlineCalendarPage
{
...
static void          cancel_validation_discover                               (GcalNewOnlineCalendarPage *self);

static void          gcal_calendar_management_page_iface_init    (GcalCalendarManagementPageInterface *iface);

G_DEFINE_FINAL_TYPE_WITH_CODE (GcalNewOnlineCalendarPage,
                               gcal_new_online_calendar_page,
...
static void
update_add_button (GcalNewOnlineCalendarPage *self)
{
...
static void
update_local_source (GcalNewOnlineCalendarPage *self)
{
...
static void
toggle_url_entry_pulsing (GcalNewOnlineCalendarPage *self,
                          gboolean             pulsing)
{
...
static void
update_url_entry_state (GcalNewOnlineCalendarPage *self,
                        EntryState           state,
...
static void
discover_sources (GcalNewOnlineCalendarPage *self)
{
...
{
  GcalNewOnlineCalendarPage *self = data;
...
sources_discovered_cb (GObject      *source_object,
                       ...
                       gpointer      user_data)
{
  GcalNewOnlineCalendarPage *self;
  g_autoptr (GPtrArray) sources = NULL;
  g_autoptr (GError) error = NULL;

  GCAL_ENTRY;

  self = GCAL_NEW_ONLINE_CALENDAR_PAGE (user_data);
...
static void
cancel_validation_discover (GcalNewOnlineCalendarPage *self)
{
...
gcal_new_calendar_page_deactivate (GcalCalendarManagementPage *page)
{
  ...
  self = GCAL_NEW_ONLINE_CALENDAR_PAGE (page);
...
{
  GcalNewOnlineCalendarPage *self = (GcalNewOnlineCalendarPage *)object;

  gtk_widget_dispose_template (GTK_WIDGET (self), GCAL_TYPE_NEW_ONLINE_CALENDAR_PAGE);

  G_OBJECT_CLASS (gcal_new_online_calendar_page_parent_class)->dispose (object);
}
...
gcal_new_calendar_page_finalize (GObject *object)
{
  ...
  G_OBJECT_CLASS (gcal_new_online_calendar_page_parent_class)->finalize (object);
}

static void
gcal_new_online_calendar_page_class_init (GcalNewOnlineCalendarPageClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/calendar/ui/gui/calendar-management/gcal-new-online-calendar-page.ui");

  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, add_button);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, calendar_address_entry);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, credentials_dialog);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, credentials_password_entry);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, credentials_user_entry);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, local_calendar_color_button);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, local_calendar_name_row);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, web_sources_listbox);
  gtk_widget_class_bind_template_child (widget_class, GcalNewOnlineCalendarPage, web_sources_revealer);
...
static void
gcal_new_online_calendar_page_init (GcalNewOnlineCalendarPage *self)
{
  self->cancellable = g_cancellable_new ();
