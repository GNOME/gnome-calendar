              ...
              GcalCalendar    *calendar)
{
  ...
  gtk_actionable_set_action_name (GTK_ACTIONABLE (self), "event-editor-dialog.select-calendar");
  gtk_actionable_set_action_target (GTK_ACTIONABLE (self), "s", gcal_calendar_get_id (calendar));
...
gcal_calendar_row_class_init (GcalCalendarRowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/calendar/ui/event-editor/gcal-calendar-row.ui");
